...
import com.example.tanv3.newsapp.Common.ISO8601Parse;
import com.example.tanv3.newsapp.DetailArticle;
...
public class ListNewsAdapter extends RecyclerView.Adapter<ListNewsViewHolder> {
    ...
    public ListNewsAdapter(List<Articles> articles, Context context) {
